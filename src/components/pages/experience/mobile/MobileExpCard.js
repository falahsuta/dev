...
import MobileDialExp from "./MobileDialExp";
  ...
  return (
    <>
      ...
      <Dialog
        ...
        disableScrollLock
        PaperComponent={() => (
          <MobileDialExp header={props.header} data={detailData[props.header]} />
        )}
      />
    </>
  );
...
export default React.memo(MobileExpCard);
