export const detailData = {
  ...
  "15-Puzzle Solver": {
    stacks: "Python",
    descriptions:
      "Command-line based app that solves 15 puzzle problems and display the steps processes. It uses branch and bound algorithm for solving the puzzle problems.",
    features:
    ...
    height: 67,
    linkto: "https://github.com/falahsuta/15-solver",
    giflink: "https://media3.giphy.com/media/eg9wtzO4w6nhdsjXs4/giphy.gif",
  },
};
